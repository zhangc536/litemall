...
@RestController
@RequestMapping("/admin/order/voucher")
@Validated
public class AdminVoucherController {
    private final Log logger = LogFactory.getLog(AdminVoucherController.class);
    ...
    @PostMapping("/upload")
    public Object upload(@RequestParam("orderId") Integer orderId, @RequestParam("file") MultipartFile file) throws IOException {
